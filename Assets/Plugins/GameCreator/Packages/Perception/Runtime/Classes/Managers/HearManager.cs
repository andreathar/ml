...
namespace GameCreator.Runtime.Perception
{
    ...
    public class HearManager : Singleton<HearManager>
    {
        ...
        [NonSerialized]
        private float m_GlobalDin;

        [NonSerialized]
        private Dictionary<int, Din> m_LocalDins;

        [NonSerialized]
        private List<GizmoNoise> m_GizmoNoises;
