...
namespace GameCreator.Runtime.Perception
{
    public class Tracker
    {
        ...
        [NonSerialized]
        private float m_Awareness;

        [NonSerialized]
        private readonly Perception m_Perception;

        [NonSerialized]
        private float m_LastIncreaseTime;
        ...
        public float Awareness
        {
            ...
            set
            {
                ...
                if (Math.Abs(this.m_Awareness - newAwareness) < float.Epsilon)
                    return;

                if (this.m_Awareness <= newAwareness)
