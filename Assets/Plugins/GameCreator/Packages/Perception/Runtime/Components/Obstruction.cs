...
namespace GameCreator.Runtime.Perception
{
    ...
    public class Obstruction : MonoBehaviour
    {
        ...
        [SerializeField]
        private PropertyGetDecimal m_SightDamping = GetDecimalConstantOne.Create;

        [SerializeField]
        private PropertyGetDecimal m_NoiseDamping = GetDecimalConstantOne.Create;

        [SerializeField]
        private PropertyGetDecimal m_ScentDamping = GetDecimalConstantOne.Create;
