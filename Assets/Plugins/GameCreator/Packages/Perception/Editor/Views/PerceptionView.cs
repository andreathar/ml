...
namespace GameCreator.Editor.Perception
{
    public class PerceptionView : VisualElement
    {
        ...
        [NonSerialized]
        private readonly Runtime.Perception.Perception m_Perception;

        [NonSerialized]
        private readonly LabelTitle m_AwarenessTitle;

        [NonSerialized]
        private readonly List<AwarenessView> m_AwarenessViews;

        [NonSerialized]
        private readonly VisualElement m_Awareness;
        ...
        private void RefreshAwareness()
        {
            ...
            this.m_AwarenessTitle.style.display =
                awarenessMap.Count > 0 ? DisplayStyle.Flex : DisplayStyle.None;
