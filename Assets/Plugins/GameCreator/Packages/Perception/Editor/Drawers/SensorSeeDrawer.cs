...
namespace GameCreator.Editor.Perception
{
    ...
    public class SensorSeeDrawer : PropertyDrawer
    {
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            fieldDimThreshold.style.display = useLuminance.boolValue
                ? DisplayStyle.Flex
                : DisplayStyle.None;
            fieldLitThreshold.style.display = useLuminance.boolValue
                ? DisplayStyle.Flex
                : DisplayStyle.None;
            ...
            SerializedProperty peripheralAngle = property.FindPropertyRelative(
                "m_PeripheralRadius"
            );
            SerializedProperty peripheralRadius = property.FindPropertyRelative(
                "m_PeripheralAngle"
            );
            SerializedProperty peripheralHeight = property.FindPropertyRelative(
                "m_PeripheralHeight"
            );
