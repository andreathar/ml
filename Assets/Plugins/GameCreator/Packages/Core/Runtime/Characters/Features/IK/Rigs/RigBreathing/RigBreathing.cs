...
namespace GameCreator.Runtime.Characters.IK
{
    ...
    public class RigBreathing : TRigAnimatorIK
    {
        ...
        {
            Transform boneChest = this.Character.Animim.Animator.GetBoneTransform(
                HumanBodyBones.Chest
            );
            Transform boneUpperChest = this.Character.Animim.Animator.GetBoneTransform(
                HumanBodyBones.UpperChest
            );

            Transform boneNeck = this.Character.Animim.Animator.GetBoneTransform(
                HumanBodyBones.Neck
            );
            Transform leftShoulder = this.Character.Animim.Animator.GetBoneTransform(
                HumanBodyBones.LeftShoulder
            );
            Transform rightShoulder = this.Character.Animim.Animator.GetBoneTransform(
