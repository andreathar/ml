...
namespace GameCreator.Runtime.Cameras
{
    ...
    public class GetGameObjectCamera : PropertyTypeGetGameObject
    {
        ...
        public override GameObject Get(Args args) =>
            this.m_Camera != null ? this.m_Camera.gameObject : null;
        ...
        public override T Get<T>(Args args)
        {
            if (typeof(T) == typeof(Camera))
                return this.m_Camera as T;
            return base.Get<T>(args);
        }

        public static PropertyGetGameObject Create =>
            new PropertyGetGameObject(new GetGameObjectCamera());

        public override string String =>
            this.m_Camera != null ? this.m_Camera.gameObject.name : "(none)";
