...
namespace GameCreator.Runtime.Common
{
    public class Args
    {
        ...
        public T ComponentFromSelf<T>(bool inChildren = false)
            where T : Component
        {
            return this.GetComponent<T>(this.m_SelfComponents, this.Self, inChildren);
        }

        public T ComponentFromTarget<T>(bool inChildren = false)
            where T : Component
        {
        ...
        public void ChangeSelf<T>(T self)
            where T : Component
        {
        ...
        public void ChangeTarget<T>(T target)
            where T : Component
        {
        ...
        private TComponent GetComponent<TComponent>(
            IDictionary<int, Component> dictionary,
